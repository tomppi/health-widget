...
data class SleepStageData(
    val startMs: Long,  // ms offset from session start
    val endMs: Long,
    val type: Int       // SleepSessionRecord.STAGE_TYPE_*
)
...
class HealthConnectManager(private val context: Context) {
    ...
    suspend fun getLatestHealthData(): HealthData {
        ...
        // Most recent record contains all samples — take last 5 from within it
        ...
        // Read latest sleep session and extract its stages
